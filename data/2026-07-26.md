...
### [2] [Flint: A Semantics-Driven Data Visualization Intermediate Language](https://arxiv.org/abs/2607.20775)
...
### [3] [Sonic Stage: Automatically Generating Interactive Spatial Soundscapes to Facilitate Dialogue Video Comprehension for Blind Viewers](https://arxiv.org/abs/2607.20835)
...
### [4] [Exploring the Design Space of LLM-Based Programming Support in CS Education: A Scoping Review through the Lens of Assistance Governance](https://arxiv.org/abs/2607.21257)
...
### [5] [Reimagining the Augmented Reality Accessibility Ecosystem for Deaf Students: Service Provider Perspectives in Experiential Learning](https://arxiv.org/abs/2607.21289)
...
### [6] [CRAFT: Exploring Wearable Creative AI on Smart Glasses for Fiction Writing in Real-World Contexts](https://arxiv.org/abs/2607.21394)
...
### [7] [Thinkink: 2D Spatial Ink-native Interaction with LLMs](https://arxiv.org/abs/2607.21468)
...
### [8] [A Needs Assessment for Measuring Geographic - Legislative Associations in the U.S. House of Representatives](https://arxiv.org/abs/2607.21502)
...
### [9] [Transparent by Design, Usable in Practice? A Formative Usability Study of a Conversational Product Advisor](https://arxiv.org/abs/2607.21513)
...
### [10] [Sources of Inequity and Fairness Risks inWellbeing Sensing](https://arxiv.org/abs/2607.21527)
...
### [11] [Isotropic deceleration and near-zero baseline acceleration in Pantheon+ supernovae: new arguments in the dark energy debate](https://arxiv.org/abs/2607.20570)
...
### [12] [Gravitational Lensing Predictions from Wave Simulations of Fuzzy Dark Matter](https://arxiv.org/abs/2607.20614)
...
### [13] [What could an emerging Big Bang Nucleosynthesis discrepancy be hinting at?](https://arxiv.org/abs/2607.20635)
...
### [14] [The correlation between voids identified in 3D large-scale-structure and 2D weak-lensing maps](https://arxiv.org/abs/2607.20637)
...
### [16] [Probing the baryonic--dark matter connection in galaxy clusters using X-rays with gated recurrent unit neural networks](https://arxiv.org/abs/2607.20721)
...
### [17] [A Multimodal Approach to Star--Galaxy Separation using SPHEREx Spectrophotometry and DESI Legacy Survey Imaging](https://arxiv.org/abs/2607.20797)
...
### [18] [A lower bound on primordial power spectrum from halo substructure](https://arxiv.org/abs/2607.20884)
...
### [19] [Reviving the Affleck-Dine Curvaton Scenario with Compensated Isocurvature Perturbations](https://arxiv.org/abs/2607.21008)
...
### [20] [Inferences for f(R) Models from Late-Time Megamaser Observational Data](https://arxiv.org/abs/2607.21129)
...
### [21] [Hubble tension: the shape wall](https://arxiv.org/abs/2607.21244)
...
### [22] [Contribution to the 2026 Cosmology session of the 60th Rencontres de Moriond: Galactic moments: Understanding polarized foregrounds complexity in the quest for CMB primordial $B$ modes with LiteBIRD](https://arxiv.org/abs/2607.21247)
...
### [23] [Web-Halo Model Peak-Background Split (WHM-PBS): halo bias as a distribution, not a number](https://arxiv.org/abs/2607.21334)
...
### [24] [Hubble tension: a short review of theoretical explanations](https://arxiv.org/abs/2607.21497)
...
### [25] [Spectral theory for population density dynamics of spiking neurons with refractoriness](https://arxiv.org/abs/2607.20699)
...
### [26] [Transition-Related Potentials as Markers of Narrative Comprehension in Continuous EEG](https://arxiv.org/abs/2607.20720)
...
### [27] [A New Model for the Milky Way Halo Dispersion Measure with the ENGAWA Simulations: Low DMs and Large Anisotropy](https://arxiv.org/abs/2607.20601)
...
### [28] [Outflows in the Early Universe: Neutral gas Absorption in Galaxies at z > 3 from low-resolution JWST Spectroscopy](https://arxiv.org/abs/2607.20606)
...
### [29] [Two stellar clocks, one history: a Gaia colour-magnitude-diagram reconstruction of the solar-neighbourhood star-formation history tested against white dwarfs](https://arxiv.org/abs/2607.20612)
...
### [30] [A Naked Dwarf: Molecular Gas in the Completely Stripped HI Tail of VCC 1249](https://arxiv.org/abs/2607.20626)
...
### [31] [Hierarchical Bayesian inference with compositional score modeling for stellar streams](https://arxiv.org/abs/2607.20725)
...
### [32] [Observations of High Galactic Latitude Line and Continuum Emission (912 - 1600 Å) with New Horizons](https://arxiv.org/abs/2607.20942)
...
### [33] [Accurate Extragalactic Magnetic Fields from Faraday Rotation with Optimal Dispersion Measure Estimators](https://arxiv.org/abs/2607.20985)
...
### [34] [Dissecting the multiple-component outflow in NGC 5548 with absorption-line Variability](https://arxiv.org/abs/2607.21029)
...
### [35] [A RELHIC twin candidate near the galaxy M51](https://arxiv.org/abs/2607.21034)
...
### [36] [Measuring Outflow Distances in NGC 5548 Using Absorption-Line Variability Diagnostics](https://arxiv.org/abs/2607.21038)
*Yaqi Chen,Zhicheng He,Guilin Liu*
...
### [37] [MIGHTEE: The Host-Galaxy Associated Catalogue of the Radio Sources in MIGHTEE Continuum Data Release 1](https://arxiv.org/abs/2607.21122)
...
### [38] [What's Missing in AGN Feedback? Lessons learnt from Magneticum, IllustrisTNG and Simba](https://arxiv.org/abs/2607.21140)
...
### [39] [The Stellar Mass Function of Gas-Rich Galaxies and the Underlying $M_{\rm HI}-M_{\rm star}$ Scaling Relation in the Local Universe](https://arxiv.org/abs/2607.21225)
...
### [40] [High-Resolution [CI] $({^3\mathrm{P}_2}\rightarrow{^3\mathrm{P}_1})$ and CO $(J=7\rightarrow6)$ Observations of Circumnuclear Disks in Nearby Seyfert Galaxies](https://arxiv.org/abs/2607.21237)
...
### [41] [ALMA CO-CAVITY II. Resolved Scaling Relations in Void Galaxies](https://arxiv.org/abs/2607.21464)
...
### [42] [Identifying and Distinguishing Quenching Galaxies with Spatially Resolved Star Formation in the Hubble Frontier Fields](https://arxiv.org/abs/2607.21560)
...
### [43] [Lightweight Gated Recurrent Unit Variants for Real-Time Channel Prediction](https://arxiv.org/abs/2607.20697)
...
### [44] [Near-Field Sampling for Line Sources](https://arxiv.org/abs/2607.20701)
...
### [45] [Self-Attention Transformer-Based Detector for Faster-than-Nyquist Signaling](https://arxiv.org/abs/2607.20745)
...
### [46] [RadioTrace: Transmitter-Aware Diffusion for Radio Map Estimation without Deployment-Time Fine-Tuning](https://arxiv.org/abs/2607.20909)
...
### [47] [Decoding Parkinsonian Tremor: An Explainable Framework Integrating Multi-Revolution Spatial and Spectral Dynamics of Spiral Drawings](https://arxiv.org/abs/2607.20930)
...
### [48] [Beyond Point Targets: Experimental Analysis of Frequency Anisotropy for Multi-band ISAC in FR3](https://arxiv.org/abs/2607.20994)
...
### [49] [Quantifying Event-Related (De)Synchronization Variability for Brain-Computer Interface: A Unified and Interpretable Framework](https://arxiv.org/abs/2607.21119)
...
### [50] [Automated Full-Sphere Measurement Methodology for Reconfigurable Intelligent Surface Beam Steering in an Anechoic Chamber](https://arxiv.org/abs/2607.21235)
...
### [51] [Constellation Selection and Power Allocation for Multi-Cell OFDM-ISAC: Managing Inter-Cell Interference and Sensing Sidelobes](https://arxiv.org/abs/2607.21418)
...
### [52] [Toward Generalizable Cognitive Impairment Detection with Speech-Based Multimodal Large Language Models](https://arxiv.org/abs/2607.21496)
